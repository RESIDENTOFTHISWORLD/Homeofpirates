            ...
            <div class="details_Container">
                <div class="details_Table">
                    <div class="details_TableHeadings">
                        ...
                        <div class="details_TableRow details_sozialLinks">
                            <div class="details_TableCell details_TableHead">SozialLinks</div>
                            <input class="details_TableCell" id="details_sozialLinkNew" value="">
                            <select class="details_TableCell" id="details_sozialType" >
                            ...
                            <div class="details_TableCell details_UpdateButton showOnUpdate" onclick="addNewSozial();">Set New Link</div>
<!--                            '<div style="flex-direction:column">' + -->
<!--                                '<a type_href="'+value["url"]+'">' + -->
<!--                                '<img class="details_sozialPreviewPic"  src="http://--><?php //=$config->domain;?><!--/img/sozials/' + value["type"] + '_sozial.png">' + -->
<!--                                '</a>'+ -->
<!--                                '</div>'; -->
                        </div>
            ...
            <div class="showOnUpdate showOnCopy" id="details_sozialPreview">
            </div>
...
<style>
    ...
    /*<!--generated by admin projects  -->*/
    .details_sozialPreviewPic {
        display: flex;
        flex-direction: row;
        text-align: center;
        justify-content: center;
...
<script>
    ...
    function addNewSozial(){
        $.ajax({
            url: "",
            type: "post",
            data: {
                actn: "setNewSozialLink",
                ctrl: "Admin/Admin_Projects",
                id: getActiveProject(),
                link: $('#details_sozialLinkNew').val(),
                type: $('#details_sozialType').val(),
            },
            success: function (response) {
                if (response === "created"){
                    reloadDetailsWindow();
